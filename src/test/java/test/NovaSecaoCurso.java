...
public class NovaSecaoCurso {
	...
	public void test() throws InterruptedException {
		...
		pageSecaoCurso.criaSecaoCurso("Aula Selenium","Aprendendo nova ferramenta de teste","13/12/2020", "18h30");
		
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		
		assertTrue("URL da página diferente da esperada", driver.getCurrentUrl().contentEquals("https://localhost:5000/courses/55/1"));	
